...
export default function ForgotPasswordScreen() {
  ...
  const { resetPassword, isResetLoading, resetError, resetSuccess } = useAuth();
          ...
          <View style={styles.card}>
            ...
            {!resetSuccess && (
              <Pressable
                style={({ pressed }) => [
                  styles.button,
                  pressed && !isResetLoading ? styles.buttonPressed : null,
                  isResetLoading ? styles.buttonDisabled : null,
                ]}
